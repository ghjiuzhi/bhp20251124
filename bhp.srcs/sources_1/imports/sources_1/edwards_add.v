...
module edwards_add#(
    ...
    input wire [`GFP_DATA_WIDTH-1:0]        tw_b_i,
...
//-----------------------------------------------------------------------------------------------------
    ...
    u_edwards_add_core(
        ...
        .rslt_u_o                   (rslt_u_o             ),
        .rslt_u_tvalid_o            (rslt_u_tvalid_o      ),
        .rslt_v0_o                  (rslt_v0_o            ),
        .rslt_v0_tvalid_o           (rslt_v0_tvalid_o     ),
        .rslt_v1_o                  (rslt_v1_o            ),
        .rslt_v1_tvalid_o           (rslt_v1_tvalid_o     ),
        .rslt_h1_o                  (rslt_h1_o            ),
        .rslt_h1_tvalid_o           (rslt_h1_tvalid_o     ),
        .rslt_x3_o                  (rslt_x3_o            ),
        .rslt_x3_tvalid_o           (rslt_x3_tvalid_o     ),
        .rslt_y3_o                  (rslt_y3_o            ),
        .rslt_y3_tvalid_o           (rslt_y3_tvalid_o     ),
